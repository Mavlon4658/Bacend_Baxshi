        ...
        <v-row>
          <v-col cols="12" sm="6">
            <div class="pa-2 grey lighten-2">
              <div class="mb-2">
                Kurs haqida <b>qisqacha</b> ma'lumot kiriting
              </div>
              <div>
                <v-textarea
                  solo
          ...
          <v-col cols="12" sm="6">
            <div class="pa-2 grey lighten-2">
              <div class="mb-2">
                Kurs haqida <b>ko'proq</b> ma'lumot kiriting.
              </div>
              <div>
                <v-textarea
                  solo
  ...
  created() {
    this.$axios
      ...
      .then((res) => {
        ...
        this.data = d
        this.title = d.title;
        this.kichik = d.descriptionSmoll;
        this.katta = d.descriptionBig;
      })
      .catch((err) => {
        console.log(err)
      })
  ...
  methods: {
    sendData() {
      if (this.image.length > 0 && this.image.length <= 10) {
        ...
        const data = {
          title: this.title,
          descriptionSmoll: this.kichik,
          descriptionBig: this.katta,
        }
