          ...
          <div class="file my-4 mb-6">
            ...
            <v-row>
              ...
              <v-col
                ...
                v-if="t"
              >
                <span class="me-3" v-if="image != null">{{
                  image.name
                }}</span>
              </v-col>
            </v-row>
        ...
        <v-row>
          <v-col cols="12" sm="6">
            <div class="pa-2 grey lighten-2">
              <div class="mb-2">
                Yangiliklar haqida <b>qisqacha</b> ma'lumot kiriting
              </div>
              <div>
                <v-textarea
                  solo
          ...
          <v-col cols="12" sm="6">
            <div class="pa-2 grey lighten-2">
              <div class="mb-2">
                Yangiliklar haqida <b>ko'proq</b> ma'lumot kiriting.
              </div>
              <div>
                <v-textarea
                  solo
  ...
  created() {
    this.$axios
      ...
      .then((res) => {
        ...
        this.kichik = res.data.desciptionSmoll;
        this.katta = res.data.desciptionBig;
      })
      .catch((err) => {
        console.log(err)
      })
  ...
  methods: {
    sendData() {
      if (this.image != null) {
        ...
        const data = {
          name: this.title,
          desciptionSmoll: this.kichik,
          desciptionBig: this.katta,
        }
