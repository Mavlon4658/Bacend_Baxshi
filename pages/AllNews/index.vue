  ...
  <div>
    <div class="pa-5">
        <div v-if="datas.length == 0">
          <h3 class="mt-5">Yangiliklar yo'q</h3>
          <v-btn class="info mt-3" to="/AddNews">Yangilik qo'shish</v-btn>
        </div>
      <div
      ...
      >
        ...
        <v-row class="my-5">
          <v-col cols="12" md="5">
            ...
            <v-img
              width="100%"
              :src="`http://localhost:3030/uploads/news/${data.image}`"
            ></v-img>
          </v-col>
          <v-col cols="12" md="7">
            <v-row>
              ...
              <v-col cols="12">
                {{ data.desciptionSmoll }}
              </v-col>
            </v-row>
            <!-- Ma'lumotlar -->
          </v-col>
          <v-col cols="12"> {{ data.desciptionBig }} </v-col>
        </v-row>
      </div>
    ...
    <UpdateNews v-if="addModal" :ID="id" @Close="close()" @Updated="updated()" />
  </div>
</template>
